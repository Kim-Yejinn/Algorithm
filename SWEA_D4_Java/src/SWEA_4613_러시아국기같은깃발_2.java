...
public class SWEA_4613_러시아국기같은깃발_2 {
//재귀함수로 사용할 경우
	static char[][] map;
	static int N, M, min;
	static char[] colors; // 재귀적으로 선택된 색깔을 담을 배열
	...
	public static void main(String[] args) {
		...
		for (int tc = 1; tc <= T; tc++) {
			...
			// 각 선택은 이전 색깔의 영향을 받음.
			// select(i) : i번재 행의 색을 선택 -->x
			// i번재 행의 선택은 i-1번째 행의 색깔에 의존, 영향을 받음
			// select(i, prevcolor): i-1번째 색이 prevColor일 때, i 번째 행의 색을 선택
